...
================================================================================
Initializing the second level server-chain CA...
...
if ! test -s "$serialFile" ; then
  # echo "Server Base CA" | od -t x1
  echo "5365727665722042617365204341000000000001" > "$serialFile"
fi
...
if ! test -s cacert.pem ; then
  echo "Create a CSR for the SECOND LEVEL server CA..."

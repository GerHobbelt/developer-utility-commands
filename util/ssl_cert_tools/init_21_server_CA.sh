...
================================================================================
Initializing the server certificates issuing (third-level) server-chain CA...
...
if ! test -s "$serialFile" ; then
  # echo "Server CA" | od -t x1
  echo "536572766572204341000000000001" > "$serialFile"
fi
...
if ! test -s cacert.pem ; then
  echo "Create a CSR for the THIRD LEVEL server CA..."
